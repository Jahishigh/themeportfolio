$(document).ready(function(){
  ...
  $(".single-project").click(function(e){
    ...
    if (clicked === 0) {
      ...
      $(".project-info").css( projectInfoCss );
			/////////////////////////////////////////////////////////////////
			var menuCss = {
				backgroundImage: "url(wp-content/themes/portfolio2017/assets/images/back.png)",
				width: "50px",
				height: "50px",
			};
      $(".menu").css( menuCss );
  ...
  $(".menu").click(function(e){
		e.preventDefault();
    if (mouse === 0) {
      $(this).css("background-image", "url(wp-content/themes/portfolio2017/assets/images/cross.png)");
      $(".menu-closed").slideToggle("slow");
      mouse = 2;
    }
    else if (mouse == 2) {
      $(this).css("background-image", "url(wp-content/themes/portfolio2017/assets/images/menu.png)");
      $(".menu-closed").slideToggle("slow");
			mouse = 0;
    }
    else if (mouse == 1){
